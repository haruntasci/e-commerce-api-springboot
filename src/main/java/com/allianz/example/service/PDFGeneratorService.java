...
public class PDFGeneratorService {
    public void export(HttpServletResponse response, BillEntity bill) throws IOException {
        ...
        try (OutputStream outputStream = response.getOutputStream()) {
            ...
            infoCell = new Cell(new Paragraph(String.valueOf(( bill.getUpdatedDate())), plainText));
            infoCell.setBorder(0);
            firstTable.addCell(infoCell);
            ...
            infoCell = new Cell(new Paragraph(bill.getOrder().getCustomer().getPerson().getName() + " "
                    + bill.getOrder().getCustomer().getPerson().getSurname(), plainText));
            infoCell.setBorder(0);
            firstTable.addCell(infoCell);
            ...
            infoCell = new Cell(new Paragraph(bill.getOrder().getCustomer().getPerson().getAddressEntityList().get(0).getAddress()
                    , plainText));
            infoCell.setBorder(0);
            firstTable.addCell(infoCell);
            ...
            infoCell = new Cell(new Paragraph(bill.getOrder().getCustomer().getPerson().getMail(), plainText));
            infoCell.setBorder(0);
            firstTable.addCell(infoCell);
            ...
            headerCell = new Cell(new Paragraph("Tax Applied", headerFont));
            headerCell.setBackgroundColor(new Color(192, 192, 192));
            table.addCell(headerCell);
            ...
            Cell amountCell = new Cell(new Paragraph("Tax-free Amount: " + decimalFormat.format(bill.getTaxFreeAmount())
                    + " TL", plainText));
            amountCell.setBorder(0);
            lastTable.addCell(amountCell);
            lastTable.addCell(emptyCell);
            amountCell = new Cell(new Paragraph("Tax Amount: " + decimalFormat.format(bill.getTaxAmount())
                    + " TL", plainText));
